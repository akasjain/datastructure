 ...
 */
public class AG15_NonOverlappingIntervals {
    ...
    public int eraseOverlapIntervals(int[][] intervals) {
        ...
        for(int[] interval : intervals) {
            intervalsSorted.add(new Interval(interval[0], interval[1]));
        }
    ...
    public static void main(String[] args) {
        ...
        AG15_NonOverlappingIntervals obj = new AG15_NonOverlappingIntervals();
